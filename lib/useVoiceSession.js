      ...
      if (offlineTextFallback) {
        ...
        if (match) {
          try {
            ...
            console.error('Offline tool trigger error:', err);
            speak("माफ़ करें, कोई समस्या आई (Sorry, there was an error).");
          }
        } else {
          speak("मुझे समझ नहीं आया, कृपया फिर से बोलें (I didn't understand, please say it again).");
        }
      } else {
        speak("ऑफ़लाइन होने के कारण, कृपया अपना आदेश लिखें (Since we are offline, please type your command).");
      }
      return;
    }
